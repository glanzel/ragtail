...
class Locale(TimestampedModel):
    ...
    class Meta:
        is_table = True
        table_name = "ragtail_locales"


class Page(TimestampedModel):
    """Hierarchical, translatable CMS page inspired by Ragtail's core Page model."""
    ...
    def get_template_name(self, request: Request, route: RouteMatch) -> str:
        """Default Ragtail-style template: ``about_page.html`` for ``AboutPage``."""
        _ = request, route
