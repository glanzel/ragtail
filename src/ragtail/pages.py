...
async def create_page(
    ...
    **extra_fields: Any,
    ...
    for name, value in extra_fields.items():
        if name in _PAGE_COLUMN_NAMES:
            column_fields[name] = value
        else:
            typed_fields[name] = value
...
async def create_translation(
    ...
    **extra_fields: Any,
    ...
    copied_fields = copy_page_model_field_values(typed_source, model)
    copied_fields.update(extra_fields)
